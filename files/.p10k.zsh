# Generated by Powerlevel10k configuration wizard on 2022-04-16 at 02:02 +08.
...
# solid, left frame, lightest-ornaments, sparse, many icons, concise,
...
() {
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_{OK,ERROR}_VIINS_CONTENT_EXPANSION='$cmd:'
